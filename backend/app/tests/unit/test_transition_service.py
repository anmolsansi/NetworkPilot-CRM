...
class TestCalculateTransition:
    def test_invite_sent(self):
        result = calculate_transition("invite_sent", previous_stage="unknown")
    ...
    def test_saved_for_later(self):
        result = calculate_transition("saved_for_later", previous_stage="unknown")
    ...
    def test_accepted(self):
        result = calculate_transition("accepted", previous_stage="unknown")
    ...
    def test_message_sent(self):
        result = calculate_transition("message_sent", previous_stage="unknown")
    ...
    def test_follow_up_1_sent(self):
        result = calculate_transition("follow_up_1_sent", previous_stage="unknown")
    ...
    def test_invalid_action(self):
        with pytest.raises(ValidationError):
            calculate_transition("invalid_action", previous_stage="unknown")
    ...
    def test_all_actions_valid(self):
        for action_type in ACTION_TRANSITIONS:
            result = calculate_transition(action_type, previous_stage="unknown")
