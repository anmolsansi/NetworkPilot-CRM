...
async def list_people(
    ...
    email_present: bool = Query(False),
    email_missing: bool = Query(False),
    location: str | None = Query(None),
    premium: bool | None = Query(None),
    processed_from: datetime | None = Query(None),
    processed_to: datetime | None = Query(None),
    invite_accepted_only: bool = Query(False),
    invite_accepted_missing: bool = Query(False),
    ...
    people, total = await service.list(
        ...
        invite_accepted_only=invite_accepted_only,
        invite_accepted_missing=invite_accepted_missing,
        favorite=favorite,
