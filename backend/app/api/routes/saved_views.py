...
async def list_saved_views(
    ...
    logger.info("saved_views.list.started workspace_id=%s user_id=%s", mask_id(str(workspace_id)), mask_id(str(user.id)))
...
async def create_saved_view(
    ...
    logger.info("saved_views.create.started workspace_id=%s user_id=%s", mask_id(str(workspace_id)), mask_id(str(user.id)))
    service = SavedViewsService(db)
...
async def update_saved_view(
    ...
    """Update a saved view."""
    logger.info("saved_views.update.started workspace_id=%s user_id=%s view_id=%s", mask_id(str(workspace_id)), mask_id(str(user.id)), mask_id(str(view_id)))
    service = SavedViewsService(db)
...
async def delete_saved_view(
    ...
    """Delete a saved view."""
    logger.info("saved_views.delete.started workspace_id=%s user_id=%s view_id=%s", mask_id(str(workspace_id)), mask_id(str(user.id)), mask_id(str(view_id)))
    service = SavedViewsService(db)
